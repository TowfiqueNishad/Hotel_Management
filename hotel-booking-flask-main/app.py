...
def create_default_rooms():
    ...
    if cur.fetchone()['cnt'] == 0:
        rooms = [
            ('Super wiz Room', 'Spacious room with a king-size bed and city view.', 150000, 'hotel-booking-flask-main/static/images/abc.jpg'),
            ('Executive Suite', 'Luxury suite with separate living area and panoramic views.', 10000, 'https://cdn.pixabay.com/photo/2020/10/18/09/16/bedroom-5664221_1280.jpg'),
            ('Family Room', 'Perfect for families with two queen beds and extra space.', 12000, 'https://cdn.pixabay.com/photo/2018/02/24/17/17/window-3178666_1280.jpg')
        ]
